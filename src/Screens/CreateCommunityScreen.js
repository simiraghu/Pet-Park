...
const CreateCommunityScreen = ({navigation}) => {
  ...
  const [aboutCommunity, setAboutCommunity] = useState(null);
  ...
  const handleCreateCommunity = async () => {
    try {
      ...
      if (!add_image) {
        msgProvider.toast(t('please_add_community_cover_image_txt'), 'bottom');
        return false;
      }
      ...
      const API_URL = config.baseURL + 'create_own_community';
    ...
    <SafeAreaView style={{flex: 1}}>
      <View style={styles.mainView}>
        ...
        <KeyboardAwareScrollView
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <Image
                    source={
                      add_image ? {uri: add_image} : localimag.icon_add_user
                    }
                    style={{
                      width: '100%',
                      height: '100%',
          ...
          {/* create modal */}
          <CommonModal
            message={t('community_create_successfully_txt')}
